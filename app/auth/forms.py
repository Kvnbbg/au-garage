...
class RegistrationForm(FlaskForm):
    ...
    email = EmailField("Email (Optional)", validators=[Optional(), Email(message="Please enter a valid email address."), validate_email_unique], render_kw={"placeholder": "Email (Optional)", "class": "form-control"})
